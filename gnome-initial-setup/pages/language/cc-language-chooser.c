...
static gchar*
normalize_casefold_and_unaccent (const gchar *str)
{
                ...
                gpointer       data)
{
        ...
        normalized_a = normalize_casefold_and_unaccent (la->locale_name);
        normalized_b = normalize_casefold_and_unaccent (lb->locale_name);
